...
| iOS           | [ComicVerse](https://guides.comicverse.ai/reading-content/intro#from-an-opds-server)                                                                                     |       :heavy_check_mark:        |        Yes         |    Yes    |
| Multiple      | [KOReader](https://koreader.rocks/)                                                                                                                                  |       :heavy_check_mark:        |         No         |    No     |
...
| iOS      | [ComicVerse](https://guides.comicverse.ai/reading-content/intro#from-an-opds-server)                                     |                                            :heavy_check_mark:                                            |        **Yes**         |                    **OPDS PSE 1.2**                       |
| iOS      | [justRead](https://apps.apple.com/us/app/epub-reader-justread-app/id6757948605)                                      |                                            :heavy_check_mark:                                            |        **Yes**         |                            No                             |
| iOS      | [KyBook 3](http://kybook-reader.com/)                                                                                |                                            :heavy_check_mark:                                            |        **Yes**         |                            No                             |
| iOS      | [Longbox](https://apps.apple.com/us/app/id6794874811)                                                                |                                            :heavy_check_mark:                                            |           No           |                     **OPDS PSE 1.0**                      |
