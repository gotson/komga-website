...
| Android       | [OPDSy](https://play.google.com/store/apps/details?id=com.opdsy)                                                                                                      |  :heavy_check_mark: <br/>(see [guide](/docs/guides/opdsy))  |         No         |    Yes    |
...
| Android  | [OPDSy](https://play.google.com/store/apps/details?id=com.opdsy)                                                      |                                 :heavy_check_mark: <br/>(see [guide](/docs/guides/opdsy))                                 |           No           |                   **OPDS PSE 1.0**                        |
